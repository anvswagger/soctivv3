...
export default {
    ...
    theme: {
        ...
        extend: {
            fontFamily: {
                sans: ['Inter', 'sans-serif'], // Switched to Inter for ultimate cleanliness, or keep Alexandria if branding requires it. Let's stick to Alexandria but potentially cleaner weight.
